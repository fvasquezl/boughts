                    ...
                    <li class="unread message dropdown-item">
                        <a href="{{ URL::to('admin/emails/'.$notification->id ) }}" class="message"> <i class="pull-right" data-toggle="tooltip"
                            ...
                            @elseif(Sentinel::getUser()->gender === "male")
                                <img src="{{ asset('img/authors/avatar3.png') }}" alt="img" class="img-fluid rounded-circle message-image"/>
                            @elseif(Sentinel::getUser()->gender === "female")
                                <img src="{{ asset('img/authors/avatar5.png') }}" alt="img" class="img-fluid rounded-circle message-image"/>

                            @else
                                <img src="{{ asset('img/authors/no_avatar.jpg') }}" alt="img" class="img-fluid rounded-circle message-image"/>
                            @endif
